from PyQt5.QtWidgets import QFrame, QGridLayout, QLabel, QLineEdit, QPushButton, QSpinBox, QHBoxLayout, QFileD        # 第三行：数量输入和生成按钮
        self.quantity_label = QLabel('数量:')
        self.quantity_input = NoWheelSpinBox()  # 使用自定义的无滚轮SpinBox
        self.quantity_input.setMinimum(1)
        self.quantity_input.setMaximum(1000)
        self.quantity_input.setValue(1)
        self.generate_button = QPushButton('预览条形码')QMessageBox
